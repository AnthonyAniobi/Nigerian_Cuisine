...
class SnackList extends AbstractFoodList {
  static final list = [
    ...
    SnackList(
        "Asun",
        AppImages.s_asun_main,
        "Asun is simply smoked/grilled/roasted peppered goat meat.\n\nIt is classified as a ”Nigerian Small chop” and served at parties as an appetizer, alongside other finger foods. Just as the name implies, Asun is ”spicy”, as in ”pepperish” and deliciously irresistible.",
        "– 1kg Goat meat with some skin\n– 2 medium sized Onion\n– 2 Bouillon cubes/stock cube\n–  1 tablespoonful thyme/oregano\n–  1 tablespoonful curry\n–  Salt to taste\n– A little vegetable oil"),
    SnackList(
        "Banana Cake",
        AppImages.s_banana_cake_main,
        "Banana cake is one popular fruit cake, and a delicious one too, here's a no fail Banana Cake recipe",
        "-145g all-purpose flour \n-1 and1/2 teaspoons baking powder\n(alternative for the above is 150g self raising flour)\n-1/2 teaspoon salt\n-1 over ripe banana\n-150g caster sugar\n-125g butter\n-2 eggs\n-60ml milk\n-2 drops vanilla essence(optional)"),
    SnackList(
        "Buns",
        AppImages.s_buns_main,
        "Nigerian Buns are normally referred to as Rock Buns, this delicious snack is usually crusty on the outside but fluffy inside.",
    ...
    SnackList(
        "Cake",
        AppImages.s_cake_main,
        "Nigerian Cake is rich, dense and delicious. It is normally present in weddings and birthday parties.",
    ...
    SnackList(
        "Chicken Pie",
        AppImages.s_chicken_pie_main,
        "Nigerian Chicken Pie is a tasty snack filled with minced de-boned chicken and vegetables. The chicken pie is very simillar to the Nigerian meat pie. The major difference between the two is the filling.",
    ...
    SnackList(
        "Chin-chin",
        AppImages.s_chin_chin_main,
        "Nigerian Chin-Chin is a crunchy deep-fried snack, and it is quite easy to make.",
    ...
    SnackList(
        "Coconut candy",
        AppImages.s_coconut_candy_main,
        "Nigerian Coconut Candy is a yummy ball of shredded coconuts. It is the nigerian version of the Colombian Chancacas. The candy is so easy to make and very sweet!",
        "-250 gram Coconut meat/flesh or 1 medium coconut\n-200 gram White Granulated/castor sugar\n-125 ml(half cup) Water"),
    SnackList(
        "Doughnut",
        AppImages.s_doughnut_main,
        "This is a very popular snack, and unsurprisingly, this snack finds its way to nigerian kitchens, and is normally available in events such as birthday parties",
    ...
    SnackList(
        ...
        "-3-5 hard boiled eggs (depending on how flat you roll the dough)\n-150 grams plain flour\n-50 grams sugar\n-1/2 levelled teaspoon baking powder\n-50 grams margarine\n-About 50 ml cool water(more or less)\n-A pinch of salt\n-Vegetable oil, for deep frying"),
    SnackList(
        "Fish pie",
        AppImages.s_fish_pie_main,
        "This is a tasty fried fish snack bearing similarity to both the meatpie and the chicken pie",
    ...
    SnackList(
        "Meat pie",
        AppImages.s_meat_pie_main,
        "Meat pie is a delicious snack, filled with vegetables and minced meat. The Nigerian meat pie is normally confused with the Enpanadas, because of their simillarity in shape, but they differ in process and fillings",
    ...
    SnackList(
        "Meat stuffed Potato(yam) balls",
        AppImages.s_potato_balls_main,
        "Stuffed potato(yam) balls is a latin american snack that has made it's way to the Nigerian kitchen. In the nigerian kitchen, the snack is also prepared with sweet patato or yams, unlike the latin American snack made with irish potato.",
        "–3 large Irish potatoes Or 6 medium yam cubes Or sweet potatoes\n–30 grams or 1½ handful ground/minced Meat(beef/chicken/shrimps or Crab meat can be used)\n-1 medium sized Carrot(chopped)\n-1 small sized Onion(chopped)( spring onions can also be used)\n-Half teaspoon Garlic powder(optional)\n-Half teaspoon chopped parsley(optional)\n-1 teaspoon thyme or oregano\n-1 teaspoon  Curry powder\n-A pinch of ground Chili pepper\n-1 Seasoning cube (knorr or Maggi)\n-1 tablespoon salt\n-Oil for deep frying\n\nFor Breading(coating)\n-5o  grams Flour\n-1 large egg (whisked)\n-50 grams Bread crumbs"),
    SnackList(
        "Puff puff",
        AppImages.s_puff_puff_main,
        "Nigerian Puff Puff is one snack you may never forget in a hurry, it is spongy, fluffy, and delicious\nIt is simillar to the arabic Luqaimat and Ghana Bofrot",
    ...
    SnackList(
        "Samosa",
        AppImages.s_samosa_main,
        "Nigerian samosa is actually a borrowed recipe from the Asian Samosa. It has become very popular in Nigeria that a lot of folks even think it is a Nigerian delicacy.",
    ...
    SnackList(
        "Scotch Eggs",
        AppImages.s_scotch_eggs_main,
        "Nigerian scotch eggs is an adaptation of the Scottish version. It is found at almost all fast food restaurants or eateris and are just delicious",
    ...
    SnackList(
        "Sharwarma",
        AppImages.s_sharwama_main,
        "This famous delicacy is commonly made with beef, chicken or the combination of both. This recipie is delicous and so easy to prepare.",
    ...
    SnackList(
        "Spring rolls",
        AppImages.s_spring_rolls_main,
        "Nigerian spring rolls are very popular spicy snack normally called \"small chop\" and served as an appetizer at parties and other festive occasions.",
